...
```bash
python3 jwtbk.py -t <token> -w <wordlist>
```

## Example

```bash
python3 jwtbk.py -t eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoidGVzdCJ9.4Dr0n9n3L9A22I3SmrnVXlrh-ahEmIBr4qFoiVOfq40 -w jwt.secrets.list
```
